/* This file (fexact.c) is taken from the source code to the 
   R project (http://www.r-project.org), and was slightly modified
   to compile independently of the R code by KRT
*/
...
L120:
	...
	if(key < 0)
	  fprintf(stderr, "Bug in FEXACT: gave negative key\n");
	/* Table index */
	ipn = key % ldst + 1;
	/* Find empty position */
